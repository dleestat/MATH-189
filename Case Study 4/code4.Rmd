...
PiLower <- function(density) {
  center <- PredictLogGain(density)
  width <- t * s.pooled * sqrt(1 + 1/m + (density-mean.density)^2 / summation)
  center - width  # Return lower end of prediction interval
}

PiUpper <- function(density) {
  center <- PredictLogGain(density)
  width <- t * s.pooled * sqrt(1 + 1/m + (density-mean.density)^2 / summation)
  center + width  # Return upper end of prediction interval
}
